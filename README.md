...
Пробел срабатывает только во время активного полёта и не влияет на обычное
состояние игрока.
...
* Отмена полёта использует клавишу пробела и может конфликтовать с другими клиентскими обработчиками прыжка.
