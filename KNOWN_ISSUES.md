# Origins: Reimagined — известные ограничения и риски

## Среда аудита

- В `/home/andrew/projects` исходный проект Origins: Reimagined отсутствует; документы создаются как стартовый каркас.
