...
import ru.origins_overhaul.client.screen.VisualTestLabScreen;
import ru.origins_overhaul.client.screen.VisualWorldDebugScreen;

public final class VisualDebugCommands {
    private VisualDebugCommands() {}
    public static void register() {
        if (!OriginsOverhaul.DEBUG) return;
