...
public final class OriginsReimaginedWaitForNextLayerScreen extends WaitForNextLayerScreen {
    private final OriginSelectionSession session;

    public OriginsReimaginedWaitForNextLayerScreen(OriginSelectionSession session) {
