...
import com.andrewimm.originsreimagined.model.*;
import com.andrewimm.originsreimagined.profiles.OriginDifficultyColorResolver;
import com.andrewimm.originsreimagined.profiles.PresentationProfile;
...
public final class ClientOriginCatalog {
    ...
    public static void rebuild() {
        ...
        if (OriginsReimagined.DEBUG) {
            OriginsReimagined.LOGGER.info("Rebuilt origin catalog: {} layers, {} origins in {} ms", layers.size(), origins.values().stream().mapToInt(List::size).sum(), (System.nanoTime() - start) / 1_000_000.0);
        }
    }
