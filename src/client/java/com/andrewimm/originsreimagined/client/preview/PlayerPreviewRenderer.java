...
public final class PlayerPreviewRenderer {
    ...
    public boolean render(GuiGraphicsExtractor context, PlayerAppearanceSnapshot appearance, PlayerPreviewCamera camera, int x, int y, int width, int height, float opacity, boolean showOuterLayer, com.andrewimm.originsreimagined.client.preview.PreviewOriginContext originContext) {
